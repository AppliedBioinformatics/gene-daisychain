...
class DBBuilder:
    ...
    def evaluate_user_request(self, user_request):
        ...
        if user_request[0] == "GFF3" and len(user_request) == 7 and user_request[1].isdigit():
            ...
            self.set_gff3_parser(user_request[1],user_request[2], user_request[3], user_request[4], user_request[5])
    ...
    def set_gff3_parser(self, proj_id, parent_feat, sub_features, name_attr, desc_attr, file_name):
        ...
        gff3_parser_v2 = GFF3Parser_v2(os.path.join("Projects", str(proj_id), "Files", "tmp.gff3"), "", False, 0,
                                       parent_feat, sub_features.split(","), name_attr.split(":"), desc_attr.split(":"))
