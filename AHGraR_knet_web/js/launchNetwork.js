...
window.onload= function() {
 ...
 var knet_menu= "<input type='image' id='relayoutNetwork' src='image/relayoutNetwork.png' onclick='rerunLayout();' title='Re-run the Layout' onmouseover='onHover($(this));' onmouseout='offHover($(this));'>"+
                    ...
                    "<span class='knet-dropdowns'>"+
                        ...
                        "<select id='changeLabelVisibility' class='knet-dropdowns' onChange='showHideLabels(this.value);' title='Select label visibility'>"+
                            ...
                            "<option value='Concepts'>Labels: Nodes</option>"+
                            "<option value='Relations'>Labels: Relations</option>"+
                            "<option value='Both' selected='selected'>Labels: All</option>"+
                        "</select>"+
                        "<select id='changeLabelFont' class='knet-dropdowns' onChange='changeLabelFontSize(this.value);' title='Select label font size'>"+
                            "<option value='2'>Label size: 2px</option>"+
                            "<option value='4'>Label size: 4px</option>"+
                            "<option value='6'>Label size: 6px</option>"+
                    ...
                    "<input type='button' id='cancel_extend_graph' style='font-size: 16px;display:none;'value='Cancel data loading' onclick='cancelGraphExtend()'></input>";
